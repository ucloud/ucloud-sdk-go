...
/*
CreateUK8SClusterV2ParamMaster0 is request schema for complex param
*/
type CreateUK8SClusterV2ParamMaster0 struct {
	
	// 第三个Master节点所属可用区，三个节点可部署在不同可用区。参见 [可用区列表](../summary/regionlist.html) 
	Zone *string `required:"true"`
	
}

/*
CreateUK8SClusterV2ParamMaster2 is request schema for complex param
*/
type CreateUK8SClusterV2ParamMaster2 struct {
	
	// 第二个Master节点所属可用区，三个节点可部署在不同可用区。参见 [可用区列表](../summary/regionlist.html) 
	Zone *string `required:"true"`
	
}

/*
CreateUK8SClusterV2ParamMaster1 is request schema for complex param
*/
type CreateUK8SClusterV2ParamMaster1 struct {
	
	// 第一个Master节点所属可用区，三个节点可部署在不同可用区。参见 [可用区列表](../summary/regionlist.html) 
	Zone *string `required:"true"`
...
type CreateUK8SClusterV2ParamMaster struct {
	...
	//  
	0 *CreateUK8SClusterV2ParamMaster0 `required:"false"`
	
	//  
	1 *CreateUK8SClusterV2ParamMaster1 `required:"false"`
	
	//  
	2 *CreateUK8SClusterV2ParamMaster2 `required:"false"`
