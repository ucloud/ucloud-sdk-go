...
type CreateAlertStrategyRequest struct {
	...
	// 通知模板id
	NotifyTemplateId *string `required:"false"`
...
// GetMetricDataAggregationMethodRequest is request schema for GetMetricDataAggregationMethod action
type GetMetricDataAggregationMethodRequest struct {
	request.CommonBase
...
// GetMetricDataAggregationMethodResponse is response schema for GetMetricDataAggregationMethod action
type GetMetricDataAggregationMethodResponse struct {
	response.CommonBase

	// 获取指标数据聚合方式返回结果
	Data GetMetricDataAggregationMethodResp
}

// NewGetMetricDataAggregationMethodRequest will create request of GetMetricDataAggregationMethod action.
func (c *CloudWatchClient) NewGetMetricDataAggregationMethodRequest() *GetMetricDataAggregationMethodRequest {
	req := &GetMetricDataAggregationMethodRequest{}
...
获取指标数据聚合方式
*/
func (c *CloudWatchClient) GetMetricDataAggregationMethod(req *GetMetricDataAggregationMethodRequest) (*GetMetricDataAggregationMethodResponse, error) {
	var err error
	var res GetMetricDataAggregationMethodResponse

	reqCopier := *req

	err = c.Client.InvokeAction("GetMetricDataAggregationMethod", &reqCopier, &res)
	if err != nil {
		return &res, err
	}
...
type QueryMetricDataSetParamMetricInfos struct {
	...
	TagOperation *string `required:"false"`
}
