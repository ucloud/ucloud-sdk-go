...
func TestScenario5065(t *testing.T) {
	spec.ParallelTest(t, &driver.Scenario{
		...
		Steps: []*driver.Step{
			...
			testStep5065ListUK8SClusterV215,
			testStep5065DeleteSubnet16,
			testStep5065DeleteVPC17,
		},
	})
}
...
var testStep5065ListUK8SClusterV215 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep5065DeleteSubnet16 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("VPC")
		if err != nil {
			return nil, err
...
var testStep5065DeleteVPC17 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("VPC")
		if err != nil {
			return nil, err
