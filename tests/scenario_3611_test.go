...
func TestScenario3611(t *testing.T) {
	spec.ParallelTest(t, &driver.Scenario{
		...
		Steps: []*driver.Step{
			...
			testStep3611GetImageCopyProgress12,
			testStep3611DescribeImage13,
			testStep3611CreateUHostInstance14,
			testStep3611DescribeUHostInstance15,
			testStep3611TerminateCustomImage16,
			testStep3611StopUHostInstance17,
			testStep3611StopUHostInstance18,
			testStep3611DescribeUHostInstance19,
			testStep3611TerminateUHostInstance20,
			testStep3611TerminateUHostInstance21,
			testStep3611TerminateCustomImage22,
			testStep3611StopUHostInstance23,
			testStep3611DescribeUHostInstance24,
			testStep3611TerminateUHostInstance25,
		},
	})
}
...
var testStep3611GetImageCopyProgress12 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
	...
	StartupDelay:  time.Duration(1800) * time.Second,
	MaxRetries:    60,
	RetryInterval: 30 * time.Second,
	Title:         "获取镜像复制进度",
	FastFail:      false,
...
var testStep3611DescribeImage13 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611CreateUHostInstance14 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611DescribeUHostInstance15 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611TerminateCustomImage16 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611StopUHostInstance18 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611DescribeUHostInstance19 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611TerminateUHostInstance21 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611TerminateCustomImage22 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611StopUHostInstance23 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611DescribeUHostInstance24 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep3611TerminateUHostInstance25 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
