...
import (
	...
	"github.com/ucloud/ucloud-sdk-go/services/ues"
...
func testSetup() {
	...
	spec.AddFixture("UES", driver.SetupClientFixture(func() (ucloud.ServiceClient, error) {
		return ues.NewClient(&cfg, &credential), nil
	}))
