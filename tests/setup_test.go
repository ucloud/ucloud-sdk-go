...
import (
	...
	"github.com/ucloud/ucloud-sdk-go/services/ses"
...
func testSetup() {
	...
	spec.AddFixture("SES", driver.SetupClientFixture(func() (ucloud.ServiceClient, error) {
		return ses.NewClient(&cfg, &credential), nil
	}))
