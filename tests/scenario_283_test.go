...
func TestScenario283(t *testing.T) {
	spec.ParallelTest(t, &driver.Scenario{
		...
		Steps: []*driver.Step{
			...
			testStep283DetachUDisk18,
			testStep283DescribeUDisk19,
			testStep283DeleteUDisk20,
			testStep283PoweroffUHostInstance21,
			testStep283DescribeUHostInstance22,
			testStep283TerminateUHostInstance23,
		},
	})
}
...
var testStep283DetachUDisk18 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep283DeleteUDisk20 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep283PoweroffUHostInstance21 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep283DescribeUHostInstance22 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
...
var testStep283TerminateUHostInstance23 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UHost")
		if err != nil {
			return nil, err
