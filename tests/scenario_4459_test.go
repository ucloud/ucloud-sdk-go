...
func TestScenario4459(t *testing.T) {
	spec.ParallelTest(t, &driver.Scenario{
		...
		Title:  "UFS-容量型（海外机房）",
		Steps: []*driver.Step{
			testStep4459DescribeUFSVolumePrice01,
			testStep4459CreateUFSVolume02,
			testStep4459DescribeUFSVolume03,
			testStep4459DescribeUFSVolume204,
			testStep4459DescribeUFSVPCSubnet05,
			testStep4459AddUFSVolumeMountPoint06,
			testStep4459DescribeUFSVolume207,
			testStep4459DescribeUFSVolumeMountpoint08,
			testStep4459DescribeUFSProductPolicy09,
			testStep4459DescribeUFSVolumeUpgradePrice10,
			testStep4459ExtendUFSVolume11,
			testStep4459DescribeUFSVolume212,
			testStep4459RemoveUFSVolumeMountPoint13,
			testStep4459DescribeUFSVolumeMountpoint14,
			testStep4459UpdateUFSVolumeInfo15,
			testStep4459DescribeUFSVolume216,
			testStep4459RemoveUFSVolume17,
		},
	})
}

var testStep4459DescribeUFSVolumePrice01 = &driver.Step{
	...
	Validators: func(step *driver.Step) []driver.TestValidator {
		return []driver.TestValidator{
			...
			validation.Builtins.NewValidator("DataSet.0.Price", step.Must(functions.Calculate("*", step.Must(functions.Calculate("*", 0.35, 100)), step.Scenario.GetVar("ufs_size"))), "str_eq"),
		}
	},
...
var testStep4459CreateUFSVolume02 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
...
var testStep4459DescribeUFSVolume03 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVolume204 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UFS")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVPCSubnet05 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459AddUFSVolumeMountPoint06 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVolume207 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UFS")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVolumeMountpoint08 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSProductPolicy09 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVolumeUpgradePrice10 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
	...
	Validators: func(step *driver.Step) []driver.TestValidator {
		return []driver.TestValidator{
			...
			validation.Builtins.NewValidator("Price", step.Must(functions.Calculate("*", step.Must(functions.Calculate("*", 0.35, 100)), step.Scenario.GetVar("ufs_size"))), "str_eq"),
		}
	},
	StartupDelay:  time.Duration(0) * time.Second,
	MaxRetries:    3,
...
var testStep4459ExtendUFSVolume11 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UFS")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVolume212 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UFS")
		if err != nil {
			return nil, err
...
var testStep4459RemoveUFSVolumeMountPoint13 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVolumeMountpoint14 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459UpdateUFSVolumeInfo15 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep4459DescribeUFSVolume216 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UFS")
		if err != nil {
			return nil, err
...
var testStep4459RemoveUFSVolume17 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UFS")
		if err != nil {
			return nil, err
