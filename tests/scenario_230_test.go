...
func TestScenario230(t *testing.T) {
	spec.ParallelTest(t, &driver.Scenario{
		...
		Title:  "ShareBandwidth自动化回归-共享带宽-基础-01",
		Steps: []*driver.Step{
			testStep230AllocateShareBandwidth01,
			testStep230AllocateEIP02,
			testStep230AssociateEIPWithShareBandwidth03,
			testStep230DescribeShareBandwidthPrice04,
			testStep230DescribeShareBandwidth05,
			testStep230ResizeShareBandwidth06,
			testStep230DescribeShareBandwidth07,
			testStep230DescribeEIP08,
			testStep230DisassociateEIPWithShareBandwidth09,
			testStep230DescribeEIP10,
			testStep230GetBandwidthSum11,
			testStep230ReleaseEIP12,
			testStep230ReleaseShareBandwidth13,
		},
	})
}

var testStep230AllocateShareBandwidth01 = &driver.Step{
...
var testStep230AllocateEIP02 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230AssociateEIPWithShareBandwidth03 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230DescribeShareBandwidthPrice04 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
...
var testStep230DescribeShareBandwidth05 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230ResizeShareBandwidth06 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230DescribeShareBandwidth07 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230DescribeEIP08 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230DisassociateEIPWithShareBandwidth09 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230DescribeEIP10 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230GetBandwidthSum11 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("")
		if err != nil {
			return nil, err
...
var testStep230ReleaseEIP12 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
...
var testStep230ReleaseShareBandwidth13 = &driver.Step{
	Invoker: func(step *driver.Step) (interface{}, error) {
		c, err := step.LoadFixture("UNet")
		if err != nil {
			return nil, err
